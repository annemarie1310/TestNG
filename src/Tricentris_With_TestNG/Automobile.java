...
public class Automobile {
    ...
    @Test(priority = 1,groups = "4Wheeler")
    public void OpenAutomobile() throws InterruptedException {
        ...
        Thread.sleep(3000);
        driver.findElement(By.xpath("//section[@class=\"idealsteps-step\"][3]//div[5]//p//label[1]")).click();
        // Select Courtesy Car
